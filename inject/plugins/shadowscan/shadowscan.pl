...
require shadowscan_translation;
...
# ---------------------------------------------------------------------------
	...
	#
        ...
        my ($std_string_arr_ref, $err_str_arr_ref) = shadowscan_translation::translate($raw_data_string);
...
$inject_utils::this_name = "shadowscan"; # TODO: put plugin name here (lowercase, no spaces)
