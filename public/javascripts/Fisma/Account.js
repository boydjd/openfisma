...
Fisma.Account = function() {
    return {
        /*
         * Used for generate a complicated password when create, update user
         */
        ...
        /*
         *  Check user account when authentication is LDAP, user information could be pulled from LDAP and then
         *  populate to related elements if the specified LDAP account name exists
         */
        checkAccount : function () {
            ...
            YAHOO.util.Connect.asyncRequest(
                ...
                url,
                {
                    ...
                    failure : function(o) {
                        alert('Failed to check account: ' + o.statusText);
                    }
                },
                null
            );
