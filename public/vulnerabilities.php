...
//		$my_v_type = $_POST['my_v_type'];
	...
	if (isset($_POST['v_keyword']) && ($search_para !='') )
	{
		$search_para = $search_para . " and  MATCH (vuln_desc_primary, vuln_desc_secondary) AGAINST ('" .$_POST['v_keyword']. "') " ;

		$v_keyword = $_POST['v_keyword'] ;
	}
	else if (isset($_POST['v_keyword']) && ($search_para =='') )
	{
		$search_para = $search_para . " MATCH (vuln_desc_primary, vuln_desc_secondary) AGAINST ('" .$_POST['v_keyword']. "') " ;
