 ...
 * @package    Fisma
 * @subpackage Fisma_Behavior_Commentable
 * @version    $Id: Proxy.php 3143 2010-03-24 21:35:38Z mhaase $
 */
class Fisma_Behavior_Commentable_Proxy
{
    /**
     ...
     * 
     * @var Fisma_Behavior_Commentable_Generator
     */
    private $_generator;
     ...
     * @param Fisma_Behavior_Commentable_Generator $generator The generator to bind this instance to
     * @return void
     */
    public function __construct(Doctrine_Record $instance, Fisma_Behavior_Commentable_Generator $generator)
    {
