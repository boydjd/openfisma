 ...
 * @package    Fisma
 * @subpackage Fisma_Behavior_AttachArtifacts
 * @version    $Id$
 */
class Fisma_Behavior_AttachArtifacts extends Doctrine_Template
{
    /**
    ...
    public function __construct(array $options = array())
    {
        ...
        $this->_plugin = new Fisma_Behavior_AttachArtifacts_Generator();
    }
     ...
     * 
     * @return Fisma_Behavior_AuditLoggable_Proxy
     */
    public function getArtifacts()
    {
        return new Fisma_Behavior_AttachArtifacts_Proxy($this->getInvoker(), $this->_plugin);
    }
}
