 ...
 */
class Fisma_Behavior_Commentable extends Doctrine_Template
{
    /**
    ...
    public function __construct(array $options = array())
    {
        ...
        $this->_plugin = new Fisma_Behavior_Commentable_Generator();
    }
    ...
    {
        return new Fisma_Behavior_Commentable_Proxy($this->getInvoker(), $this->_plugin);
    }
}
