 ...
 * @version    $Id$
 */
class Fisma_Behavior_AttachArtifacts_Proxy
{
    /**
     ...
     * 
     * @var Fisma_Behavior_AttachArtifacts_Generator
     */
    private $_generator;
     ...
     * @return void
     */
    public function __construct(Doctrine_Record $instance, Fisma_Behavior_AttachArtifacts_Generator $generator)
    {
