...
class Fisma_Yui_Tooltip
{
     ...
     * @param string $escape Optional, default to 'html'. The customized escape type for $title
     * @return void
     */
    function __construct($id, $title, $content, $escape = 'html')
    {
        $this->_id = $id;
        $this->_title = $title;
