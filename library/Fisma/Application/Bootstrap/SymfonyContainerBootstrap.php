...
/**
 * Fisma_Application_Bootstrap_SymfonyContainerBootstrap 
 * 
 * @uses Zend_Application_Bootstrap_Bootstrap
 * @package Fisma_Application_Bootstrap 
 * @version $Id$
 ...
 */
class Fisma_Application_Bootstrap_SymfonyContainerBootstrap extends Zend_Application_Bootstrap_Bootstrap
{
    /**
     *  
     */
    ...
    public function getContainer()
    {
        ...
        if (null === $this->_container && $options['container']['type'] == 'symfony') {
            ...
            Zend_Controller_Action_HelperBroker::addHelper(new Fisma_Controller_Action_Helper_DependencyInjection());
        }
