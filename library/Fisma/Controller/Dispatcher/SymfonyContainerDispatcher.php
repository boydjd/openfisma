...
/**
 * Fisma_Controller_Dispatcher_SymfonyContainerDispatcher 
 * 
 * @uses Zend_Controller_Dispatcher_Standard
 * @package Fisma_Controller_Dispatcher 
 * @version $Id$
 * @copyright (c) Endeavor Systems, Inc. 2009 {@link http://www.endeavorsystems.com}
 * @author Josh Boyd <joshua.boyd@endeavorsystems.com> 
 * @license http://www.openfisma.org/content/license GPLv3
 */
class Fisma_Controller_Dispatcher_SymfonyContainerDispatcher extends Zend_Controller_Dispatcher_Standard
{
    /**
     * dispatch 
     * 
    ...
    public function dispatch(Zend_Controller_Request_Abstract $request, Zend_Controller_Response_Abstract $response)
    {
         ...
         */
        if (Zend_Registry::isRegistered(Fisma_Application_Bootstrap_SymfonyContainerBootstrap::getRegistryIndex())) {
            $container = Zend_Registry::get(Fisma_Application_Bootstrap_SymfonyContainerBootstrap::getRegistryIndex());
