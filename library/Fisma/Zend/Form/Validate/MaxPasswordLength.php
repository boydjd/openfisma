 ...
 * @version    $Id$ 
 */
class Fisma_Zend_Form_Validate_MaxPasswordLength extends Zend_Validate_Abstract
{
    /**
     ...
     * @todo suggest rename class name to Fisma_Zend_Form_Validate_MinPasswordLength 
