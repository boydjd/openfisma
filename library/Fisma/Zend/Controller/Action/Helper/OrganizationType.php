...
class Fisma_Zend_Controller_Action_Helper_OrganizationType extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function getFilterForm($selectedValue, $includeNone = true)
    {
        ...
        $filterForm = Fisma_Zend_Form_Manager::addDefaultElementDecorators($filterForm);
        $filterForm->getElement('orgTypeFilter')->setOptions(array(
            'onChange' => 'Fisma.Organization.typeSelector()'
        ));
