 ...
 */
class Fisma_Doctrine_Behavior_HasPocs extends Doctrine_Template
{
    /**
    ...
    public function __construct(array $options = array())
    {
        ...
        $this->_plugin = new Fisma_Doctrine_Behavior_HasPocs_Generator();
    }
    ...
    public function setUp()
    {
        ...
        $foreignClassName = $this->getTable()->getComponentName() . 'Poc';
