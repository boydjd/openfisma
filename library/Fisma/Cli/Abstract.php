...
abstract class Fisma_Cli_Abstract
{
     ...
     *
     * @param int $userId Optional, default to 0. The ID of the User associated with this upload.
     * @return Upload
     */
    public static function generateAttachment($userId = 0)
    {
        $upload = new Upload();
        ...
        $upload->uploadIp = '127.0.0.1';
        $upload->description = 'This upload is generated by a CLI script.';
