...
/**
 * Test_Application_Models_IrSubCategoryTable 
 * 
 ...
 */
class Test_Application_Models_IrSubCategoryTable extends Test_FismaUnitTest
{
    /**
    ...
    {
        $this->assertTrue(is_array(IrSubCategoryTable::getAclFields()));
    }
}
