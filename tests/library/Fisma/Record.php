...
/**
 * Tests for the Fisma_Record class
 * 
 * @author     Mark E. Haase
 ...
 * @version    $Id$
 */
class Test_Library_Fisma_Record extends Test_FismaUnitTest
{
    /**
     * Test the ability to get an original value even after a field is modified several times.
     * 
     * In order to test this, we need to use a known subclass, since Fisma_Record itself does not contain all of the 
     * functionality required to test this. (Namely, it doesn't contain any setUp or setTableDefinition.) We use
