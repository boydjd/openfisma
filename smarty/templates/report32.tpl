...
<table width="95%" align="center" border="0" cellpadding="5" cellspacing="0" class="tbframe"  >
	<!-- table header row -->
	<tr align="center">
        <th>{$report_lang[3][1][2][5]}</th>
        <th>{$report_lang[3][1][2][6]}</th>
        <!-- <th width="13%">{$report_lang[3][1][2][7]}</th> -->
        <th>{$report_lang[3][1][2][8]}</th>
        <th>{$report_lang[3][1][2][9]}</th>
        <th>{$report_lang[3][1][2][10]}</th>
        <th>{$report_lang[3][1][2][11]}</th>
        <th nowrap>{$report_lang[3][1][2][12]}</th>
    </tr>
		<!-- table detail rows -->
		{foreach item=item from=$rpdata[0]}
        <tr align="center">
        <td align="left" class="tdc">{$item.name}</td>
