...
<!--
use this to get IE to pass 'submit' on image input button click
-->
...
<table width="98%" border="0" cellpadding="3" cellspacing="1" class="tipframe">
  <tr>
    <td width="363" rowspan="2" align="left" valign="top">  	      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tipframe">
            ...
            <tr>
              <td  align="left"><textarea name="vuln_desc_primary" cols="55" rows="3">{$vuln_desc_primary}</textarea></td>
            </tr>
          </table>
            ...
            <tr>
              <td  align="left"><textarea name="vuln_desc_secondary" cols="55" rows="3">{$vuln_desc_secondary}</textarea>
      </td>
            </tr>
          </table>
		  <br>
          <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tipframe">
            <tr>
              <th colspan="2"  align="left"> Vulnerability Severity:  <input name="vuln_severity" type="text" value="{$vuln_severity}"> (value 0-100)</th>
            </tr>
          </table>
      </td><td colspan="2">
	<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tipframe">
        ...
        <tr>
          <td width="50%"  align="left"><input type="checkbox" name="vuln_loss_confidentiality" value="1"  {$vuln_loss_confidentiality_checked} >Confidentiality   </td>
          <td width="50%"  align="left"><input type="checkbox" name="vuln_loss_security_admin"  value="1" {$vuln_loss_security_admin_checked}>Security Admin </td>
        </tr>
        <tr>
          <td  align="left"><input type="checkbox" name="vuln_loss_availability"  value="1" {$vuln_loss_availability_checked}>Availability </td>
          <td  align="left"><input type="checkbox" name="vuln_loss_security_user"  value="1"  {$vuln_loss_security_user_checked}>Security User </td>
        </tr>
        <tr>
          <td  align="left"><input type="checkbox" name="vuln_loss_integrity"  value="1" {$vuln_loss_integrity_checked}>Integrity</td>
          <td  align="left"><input type="checkbox" name="vuln_loss_security_other"   value="1" {$vuln_loss_security_other_checked}>Security Other </td>
        </tr>
      </table>
    ...
    <td width="252" colspan="2" align="right">
        ...
        <tr>
          <td  align="left"><input type="checkbox" name="vuln_range_local" value="1" {$vuln_range_local_checked} >Local</td>
          </tr>
        <tr>
          <td  align="left"><input type="checkbox" name="vuln_range_remote" value="1"  {$vuln_range_remote_checked} >Remote</td>
          </tr>
        <tr>
          <td  align="left"><input type="checkbox" name="vuln_range_user" value="1"{$vuln_range_user_checked} >User</td>
          </tr>
      </table>
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tipframe">
      ...
      <tr>
        <td width="219"><input type="checkbox" name="vuln_type_access" value="1" {$vuln_type_access_checked} >      Acccess</td>
        <td width="221"><input type="checkbox" name="vuln_type_input_buffer" value="1" {$vuln_type_input_buffer_checked}>      Input buffer </td>
        <td width="208"  align="left"><input type="checkbox" name="vuln_type_exception" value="1" {$vuln_type_exception_checked}>      Except</td>
        <td width="161"  align="left"><input type="checkbox" name="vuln_type_other" value="1" {$vuln_type_other_checked}>      Other</td>
      </tr>
      <tr>
        <td><input type="checkbox" name="vuln_type_input" value="1" {$vuln_type_input_checked}>       Input</td>
        <td><input type="checkbox" name="vuln_type_race" value="1" {$vuln_type_race_checked}>      Race</td>
        <td  align="left"><input type="checkbox" name="vuln_type_environment" value="1" {$vuln_type_environment_checked}>      Environment</td>
        <td  align="left">&nbsp;</td>
      </tr>
      <tr>
        <td><input type="checkbox" name="vuln_type_input_bound" value="1" {$vuln_type_input_bound_checked}>      Input bound </td>
        <td><input type="checkbox" name="vuln_type_design" value="1" {$vuln_type_design_checked}>      Design</td>
        <td  align="left"><input type="checkbox" name="vuln_type_config" value="1" {$vuln_type_config_checked}>      Config</td>
        <td  align="left">&nbsp;</td>
      </tr>
    </table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbline">
<tr>
	<td valign="bottom"><!--<img src="images/greenball.gif" border="0"> --><b>Product Affected </b></td>
	<td align="right" valign="bottom">&nbsp;</td>
</tr>
</table>
<br	>
  Current Products for Vulnerability : {$vuln_seq}
  ...
  <tr>
    <td  align="center"  class="tdc">
        ...
        <input type="image"   src="images/del.png" border="0" onClick="del_product({$selected_product[row].prod_id})" >
	
	 </td>
    <td  align="left" class="tdc">&nbsp;{$selected_product[row].prod_vendor}
