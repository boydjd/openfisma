					...
					<td width="30%" align="right" valign="top">
						...
						<table border="0" cellpadding="2" cellspacing="3">
							...
							<tr>
								...
								<td><input type="password" name="userpass" value="" size="16"
									onBlur="checkpwd(	document.login.username, 
														document.login.userpass, 
														3, 
														false);">
								</td>
							</tr>
							...
							<tr>
								<td colspan="2" align="right">
									<input type="submit" value="Login" 
										onClick="return confirmpwd(	document.login.userpass,
																	document.login.cfmpass);">
								</td>
							</tr>
							...
							<tr>
								<td colspan="2" align="right"><input type="submit" value="Login" name="log" class="squarebutton"></td>
							</tr>
