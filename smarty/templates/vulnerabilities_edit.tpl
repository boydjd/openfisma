		...
		<td>
			<table>
				...
				<td>
					...
					<input type="submit" name="submit" value="Update Vulnerability">
				</td>
			</table>
		</td>
	</tr>
</table>
<!-- End Back & Save Button -->
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tipframe">
				...
				<tr>
					<td width="50%" align="left">
						<input type="checkbox" 
								name="vuln_loss_confidentiality" 
								value="1"  
								{$v_table.vuln_loss_confidentiality} > Confidentiality   
					</td>
					<td width="50%"  align="left">
						<input type="checkbox" 
								name="vuln_loss_security_admin"  
								value="1" 
				...
				<tr>
					<td  align="left">
						<input type="checkbox" 
								name="vuln_loss_availability"  
								value="1" 
								{$v_table.vuln_loss_availability} > Availability 
					</td>
					<td align="left">
						<input type="checkbox" 
								name="vuln_loss_security_user"  
								value="1"  
				...
				<tr>
					<td align="left">
						<input type="checkbox" 
								name="vuln_loss_integrity"  
								value="1" 
								{$v_table.vuln_loss_integrity} > Integrity
					</td>
					<td align="left">
						<input type="checkbox" 
							name="vuln_loss_security_other"   
							value="1" 
		...
		<td width="252" colspan="2" align="right">
			...
			<table width="98%" border="0" cellpadding="3" cellspacing="1" class="tipframe">
				...
				<tr>
					<td  align="left">
						<input type="checkbox" 
							name="vuln_range_local" value="1" 
							{$v_table.vuln_range_local} > Local
					</td>
				</tr>
				<tr>
					<td  align="left">
						<input type="checkbox" 
							name="vuln_range_remote" value="1"  
							{$v_table.vuln_range_remote} > Remote
					</td>
				</tr>
				<tr>
					<td align="left">
						<input type="checkbox" 
							name="vuln_range_user" value="1"
							{$v_table.vuln_range_user} > User
					</td>
				</tr>
			</table>
		</td>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tipframe">
				...
				<tr>
					<td>
						...
						{$v_table.vuln_type_input_bound} > Input bound 
					</td>
					<td>
						<input type="checkbox" name="vuln_type_design" value="1" 
						{$v_table.vuln_type_design} > Design
					</td>
					<td align="left">
						<input type="checkbox" name="vuln_type_config" value="1" 
						{$v_table.vuln_type_config} > Config
					</td>
					<td align="left">&nbsp;</td>
				</tr>
			</table>
...
<!-- Products Effected Table -->
<table width="95%" align="center" border="0" cellpadding="3" cellspacing="1" class="tbframe" >
	<tr>
	...
	<tr>
		<td colspan="2" align="left">&nbsp;Product Search: 
			...
			<INPUT TYPE="BUTTON" VALUE="Create New Product" 
				ONCLICK="window.location.href='tbadm.php?tid=4&r_do=form'">
		</td>
    </tr>
	<tr>
