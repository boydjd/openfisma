...
class Application_Migration_021800_FindingConfig extends Fisma_Migration_Abstract
{
    ...
    public function migrate()
    {
        ...
        $threatOption = array(
            'type' => "enum('threat_level','residual_risk')",
        ...
        $this->getHelper()->addColumn('configuration', 'threat_type', $threatOption);
        $this->getHelper()->addColumn('configuration', 'use_legacy_finding_key', $legacyOption);
    }
}
