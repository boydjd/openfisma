 ...
 * @package    Model
 */
class SystemTypeTable extends Fisma_Doctrine_Table implements Fisma_Search_Searchable
{
    ...
    /**
     * Return a dictioanry of types where the keys are the type's primary keys.
     *
     * @return array
     */
