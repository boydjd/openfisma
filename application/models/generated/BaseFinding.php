...
abstract class BaseFinding extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('type', 'enum', null, array('type' => 'enum', 'values' => array(0 => 'NONE', 0 => 'CAP', 1 => 'AR', 2 => 'FP'), 'default' => 'NONE', 'comment' => 'The mitigation type (Corrective Action Plan, Accepted Risk, or False Positive)'));
