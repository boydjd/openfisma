...
/**
 * A view helper which translates and escapes the logicalName of a column for the current $view->table
 *
...
class View_Helper_GetColumn extends Zend_View_Helper_Abstract
{
    function getColumn($columnName, $view = null, $table = null) {
        ...
        if ($view && $table) {
            return $view->escape($view->translate($table->getLogicalName($columnName)));
        }
        return $columnName;
    }
}
