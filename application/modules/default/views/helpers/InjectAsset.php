...
class View_Helper_InjectAsset
{
    ...
    private static $_depMap = array(
                                ...
                                array('/javascripts/php.js',
                                      ...
                                      '/javascripts/jqPlot/jquery-ui-181custom_min.js',
                                      '/javascripts/jqPlot/jquery_jqplot.js',
                                      '/javascripts/jqPlot/jqplot_canvasTextRenderer.js',
                                      '/javascripts/jqPlot/jqplot_canvasAxisLabelRenderer.js',
                                      '/javascripts/jqPlot/jqplot_canvasAxisTickRenderer.js',
                                      '/javascripts/jqPlot/jqplot_categoryAxisRenderer.js',
                                      '/javascripts/jqPlot/jqplot_barRenderer.js',
                                      '/javascripts/jqPlot/jqplot_pointLabels.js',
                                      '/javascripts/jqPlot/jqplot_pieRenderer.js',
