...
/**
 * Migrate finding audit logs from old table to new table
 * 
 * This has to be done separately from #15 because you can't create a table and populate it in the same migration.
 * 
 * @author     Mark E. Haase
 ...
 * @version    $Id$
 */
class MigrateFindingAuditLog extends Doctrine_Migration_Base
{
    /**
    ...
    public function up()
    {
        ...
        $query = "INSERT INTO finding_audit_log 
                  SELECT
                      null,
                      createdts,
                      description,
