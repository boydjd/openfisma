 ...
 */
class AddFindingUpdateEvent extends Doctrine_Migration_Base
{
    /**
     * Insert new event
     */
    public function up()
    {
        // Create new event
        $event = new Event;
        $event->name = 'FINDING_UPDATED';
        $event->description = 'Finding Updated';
    ...
    {
        Doctrine::getTable('Event')->findOneByName('FINDING_UPDATED')->delete();
    }
}
