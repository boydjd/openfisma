...
/**
 * CreateTablesForFindingMetadata 
 * 
 * @package Migration
 * @version $Id$
 ...
 */
class CreateTablesForFindingMetadata extends Doctrine_Migration_Base
{
    /**
     * Create tables needed for finding metadata provided by Nessus scans
     */
    public function up()
    {
        $this->createTable(
        ...
        $this->addColumn(
            'finding', 'cvssvector', 'string', '', array(
    ...
    /**
     * Drop tables and new columns for nessus metadata 
     */
