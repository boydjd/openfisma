...
<tr align="center">
    ...
    <th>Role</th>
    <th>Username</th>
    <?php if(Config_Fisma::isAllow('admin_users','update')){
              echo'<th>Edit</th>';
          }
          if(Config_Fisma::isAllow('admin_users','read')){
              echo'<th>View</th>';
          }
          if(Config_Fisma::isAllow('admin_users','delete')){
              echo'<th>Del</th>';
          }
    ?>
</tr>
