...
<tr align="center">
    ...
    <th>Vendor</th>
    <th>Version</th>
    <?php if(Config_Fisma::isAllow('admin_products','update')){
              echo'<th>Edit</th>';
          } 
          if(Config_Fisma::isAllow('admin_products','read')){
              echo'<th>View</th>';
          }
          if(Config_Fisma::isAllow('admin_products','delete')){
              echo'<th>Del</th>';
          }
    ?>
</tr>
...
<tr>
    ...
    <?php } if(Config_Fisma::isAllow('admin_products','read')){ ?>
    <td class="tdc" align="center">
        <a href="/panel/product/sub/view/id/<?php echo $product['id'];?>" title="display the Products">
        <img src="/images/view.gif" border="0"></a>
    </td>
    <?php } if(Config_Fisma::isAllow('admin_products','delete')){ ?>
    <td class="tdc" align="center">
        <a href="/panel/product/sub/delete/id/<?php echo $product['id'];?>" title="delete the Products, then no restore after deleted" onclick="return delok('Product');">
