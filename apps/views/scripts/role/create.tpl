...
<form name="edit" method="post" action="<?php echo burl()?>/panel/role/sub/create/s/save">
    <tr>
        <td align="right" class="thc" width="200">Role Name:</td>
        <td class="tdc">&nbsp;<input type="text" name="role_name" size="90"><font color="blue"> *</font></td>
    </tr>
    <tr>
        <td align="right" class="thc">Nickname:</td>
        <td class="tdc">&nbsp;<input type="text" name="role_nickname" size="90"><font color="blue"> *</font></td>
    </tr>
    <tr>
        <td align="right" class="thc" width="200">Description:</td>
        <td class="tdc">&nbsp;<textarea name="role_desc" size="30" cols="110" rows="5"></textarea></td>
    </tr>
   </table>
<br>
<br>
