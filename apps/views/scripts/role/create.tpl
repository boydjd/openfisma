...
<form id="roleform" name="edit" method="post" action="<?php echo burl()?>/panel/role/sub/create/s/save">
<table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" class="tbframe">
    ...
    <tr>
        ...
        <td class="tdc"><textarea name="role[desc]" cols="80" rows="10"></textarea></td>
    </tr>
   </table>
<br>
