<div class="barleft">
<div class="barright">
<p><b>Administration: Products Create</b>
</div>
</div>
...
<form name="edit" method="post" action="<?php echo burl()?>/panel/product/sub/create/s/save">
    <tr>
        <td align="right" class="thc" width="200">Product Name:</td>
        <td class="tdc">&nbsp;<input type="text" name="prod_name" size="90"><font color="blue"> *</font></td>
    </tr>
    <tr>
        <td align="right" class="thc">Vendor:</td>
        <td class="tdc">&nbsp;<input type="text" name="prod_vendor" size="90"><font color="blue"> *</font></td>
    </tr>
    <tr>
        <td align="right" class="thc">Version:</td>
        <td class="tdc">&nbsp;<input type="text" name="prod_version" size="90"><font color="blue"> *</font></td>
    </tr>
 
    <tr>
        <td align="right" class="thc" width="200">Description:</td>
        <td class="tdc">&nbsp;<textarea name="prod_desc" size="30" cols="110" rows="5"></textarea></td>
    </tr>
   </table>
<br>
<br>
