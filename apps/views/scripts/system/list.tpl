...
<tr align="center">
    ...
    <th>Availability</th>
    <th>Type</th>
    <?php if(Config_Fisma::isAllow('admin_systems','update')){
              echo'<th>Edit</th>';
          } 
          if(Config_Fisma::isAllow('admin_systems','read')){
              echo'<th>View</th>';
          }
          if(Config_Fisma::isAllow('admin_systems','delete')){
              echo'<th>Del</th>';
          }
    ?>
</tr>
