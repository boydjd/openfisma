...
class RiskAssessment {
  ...
  */
  function get_data_sensitivity() {
    ...
    if ($this->confidentiality == $this->HIGH ||
        $this->availability    == $this->HIGH ||
        $this->integrity       == $this->HIGH) {
      $sensitivity = $this->HIGH;
      }
    // If nothing HIGH, look for MODERATE high water mark
    else if ($this->confidentiality == $this->MODERATE ||
             $this->availability    == $this->MODERATE ||
             $this->integrity       == $this->MODERATE) {
