...
$table_field_arr		= array(array("user_name_last","user_name_first","user_phone_office","user_phone_mobile","user_email","role_id","user_title","user_is_active","user_name","user_password"),
								...
								array("system_name","system_nickname","system_primary_office","system_confidentiality","system_integrity","system_availability","system_type","system_desc","system_criticality_justification","system_sensitivity_justification"),
...
$table_field_name_arr		= array(array("Last Name","First Name","Office Phone","Mobile Phone","Email","Role","Title","Status","Username","Password"),
									...
									array("System Name","Nickname","Primary Office","Confidentiality","Integrity","Availability","Type","Description","Criticality Justification","Sensitivity Justification"),
...
$table_field_type_arr	= array(array("char","char","char","char","email","int","char","int","char","password"),
								...
								array("char","char","int","int","int","int","char","text","text","text"),
...
$table_field_len_arr	= array(array(32,32,13,13,64,10,32,1,32,32),
								array(64,64,65000),
								array(128,8,10,10,10,10,22,65000,65000,65000),
...
$table_relation_arr		= array(array(array(0),array(0),array(0),array(0),array(0),array(1,"ROLES","role_id","role_name"),array(0),array(2,array("1"=>"Active","0"=>"Suspend")),array(0),array(0)),
								...
								array(array(0),array(0),array(2,array("0"=>"FSA")),array(2,array("HIGH"=>"High","MODERATE"=>"Moderate","LOW"=>"Low")),array(2,array("HIGH"=>"High","MODERATE"=>"Moderate","LOW"=>"Low")),array(2,array("HIGH"=>"High","MODERATE"=>"Moderate","LOW"=>"Low")),array(0),array(0),array(0),array(0)),
